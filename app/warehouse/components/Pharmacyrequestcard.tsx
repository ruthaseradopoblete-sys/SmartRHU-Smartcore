...
export default function PharmacyRequestsCard() {
  ...
  /**
   * Confirms a restock request via confirmRestockTransfer() — the ONLY
   * place stock moves from warehouse_medicines to pharma_medicines. Do not
   * add any other listener/trigger that also writes to pharma_medicines on
   * this same status change, or stock will double again.
   */
