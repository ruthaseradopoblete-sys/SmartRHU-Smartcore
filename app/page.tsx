  ...
  return (
    <div style={{minHeight:"100vh",background:"#f0f7f2",fontFamily:"DM Sans,sans-serif",display:"flex",flexDirection:"column"}}>
      <header style={{background:"#0d3b1f",padding:"0 24px",height:60,display:"flex",alignItems:"center",justifyContent:"space-between",flexShrink:0}}>
        <span style={{fontFamily:"Syne,sans-serif",fontWeight:800,fontSize:16,color:"#fff",letterSpacing:"0.06em"}}>SMARTRHU — Admin</span>
      ...
      <div style={{flex:1,display:"flex",alignItems:"center",justifyContent:"center",flexDirection:"column",gap:16}}>
        ...
        <h1 style={{fontFamily:"Syne,sans-serif",fontWeight:800,fontSize:28,color:"#0a2912"}}>Admin Dashboard</h1>
