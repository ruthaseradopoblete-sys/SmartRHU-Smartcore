...
export default function DoctorTopbar({
  ...
  // Keep a stable ref so Supabase callbacks always call the latest version
  ...
  useEffect(() => {
    ...
    const ch = supabase.channel("doctor_topbar_realtime");
    ...
    // Lab results across all result tables
    for (const table of LAB_RESULT_TABLES) {
      ch.on(
        ...
        ({ new: row }) => {
          ...
          notify(
            "lab_result",
            `Lab result ready — ${label}`,
            resolvePatient(row as Record<string, unknown>),
            table
          );
        }
      );
    ...
    ch.subscribe((status) => {
      console.log("[DoctorTopbar] Supabase channel status:", status);
    });
  ...
  useEffect(() => {
    ...
    // Use "click" not "mousedown" so the bell's own onClick fires first
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
                ...
                >
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                    <button
                      ...
                      style={{
                        background: soundEnabled ? "rgba(255,255,255,0.18)" : "rgba(239,68,68,0.45)",
                    ...
                    notifications.map((n, i) => (
                      ...
                      >
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <p
                            style={{
                              fontSize: 10, margin: "2px 0 0", color: "#9ca3af",
                              fontFamily: "DM Sans, sans-serif",
                            }}
                          >
                            {timeAgo(n.timestamp)}
          ...
          <div ref={profileRef} style={{ position: "relative" }}>
            <button
              ...
              onMouseLeave={(e) => {
                if (!showProfile) e.currentTarget.style.background = "rgba(255,255,255,0.12)";
              }}
            >
              <div
                style={{
                ...
                <div style={{ padding: "8px 0" }}>
                  {[
                    ...
                    <button
                      ...
                      style={{
                        ...
                        cursor: "pointer", fontFamily: "DM Sans, sans-serif",
                        transition: "background .12s", textAlign: "left" as const,
                      }}
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => {
                      ...
                      (e.currentTarget.querySelector("span:last-child") as HTMLElement).style.color = "#dc2626";
                    }}
                    onMouseLeave={(e) => {
                  ...
                  >
                    ...
                    <span style={{ fontSize: 13, fontWeight: 700, color: "#dc2626", transition: "color .12s" }}>
                      Logout
                    </span>
                  </button>
                </div>
