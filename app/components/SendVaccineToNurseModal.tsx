    ...
    <>
      ...
      {showReviewConfirm && (
        <div
          ...
          style={{ position: "fixed", inset: 0, zIndex: 3200, background: "rgba(0,0,0,0.45)", backdropFilter: "blur(4px)", display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }}
        >
          <div
            onClick={(e) => e.stopPropagation()}
            style={{ background: "#fff", borderRadius: 20, width: "min(480px, 95vw)", boxShadow: "0 24px 70px rgba(0,0,0,0.28)", fontFamily: "'Nunito', sans-serif", overflow: "hidden" }}
          >
            {/* Header */}
            <div style={{ background: `linear-gradient(135deg, ${GREEN_DARK}, ${GREEN_DARK2})`, padding: "20px 24px 22px", position: "relative" }}>
              <div style={{ position: "absolute", top: 16, right: 18, background: "rgba(255,255,255,0.18)", borderRadius: 99, padding: "4px 14px", fontSize: 12, fontWeight: 700, color: "#fff" }}>
            ...
            <div style={{ padding: "20px 22px", display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div style={{ background: INPUT_BG, border: `1.5px solid ${INPUT_BD}`, borderRadius: 14, padding: "16px 18px" }}>
                <div style={{ fontSize: 10, fontWeight: 800, color: GREEN_DARK, letterSpacing: 1, textTransform: "uppercase", marginBottom: 10 }}>
                  Patient Information
                </div>
              ...
              {/* Vaccines list */}
              <div>
                <div style={{ fontSize: 11, fontWeight: 800, color: "#111827", letterSpacing: 0.5, textTransform: "uppercase", marginBottom: 10 }}>
                  Vaccines to Administer ({selected.length})
                </div>
                <div style={{ background: INPUT_BG, border: `1.5px solid ${INPUT_BD}`, borderRadius: 14, overflow: "hidden" }}>
                  <div style={{ background: GREEN_DARK, padding: "7px 16px", display: "flex", alignItems: "center", gap: 7 }}>
                    <span style={{ fontSize: 13 }}>💉</span>
                    <span style={{ fontSize: 11, fontWeight: 800, color: "#fff", letterSpacing: 0.5 }}>RHU NURSE STATION</span>
                  </div>
              ...
              {/* Notice box */}
              <div style={{ background: "#fffbeb", border: "1.5px solid #fcd34d", borderRadius: 12, padding: "10px 14px", display: "flex", alignItems: "center", gap: 8 }}>
            ...
            {/* Footer */}
            <div style={{ padding: "14px 22px", borderTop: "1px solid #f1f5f9", display: "flex", gap: 10, justifyContent: "flex-end", background: "#fff" }}>
              <button
                onClick={() => setShowReviewConfirm(false)}
                style={{ padding: "10px 24px", borderRadius: 99, border: "1.5px solid #d1d5db", background: "#fff", color: "#374151", fontSize: 13, fontWeight: 700, cursor: "pointer", fontFamily: "'Nunito', sans-serif" }}
              >
                ← Back
              </button>
              <button
                onClick={handleConfirmedSend}
                style={{ padding: "10px 28px", borderRadius: 99, border: "none", background: `linear-gradient(135deg, ${GREEN_DARK}, ${GREEN})`, color: "#fff", fontSize: 13, fontWeight: 800, cursor: "pointer", fontFamily: "'Nunito', sans-serif", boxShadow: "0 2px 10px rgba(21,128,61,0.35)", display: "flex", alignItems: "center", gap: 8 }}
              >
                ✓ Confirm
              </button>
            </div>
      ...
      {showCloseConfirm && (
        <div
          ...
          style={{ position: "fixed", inset: 0, zIndex: 3100, background: "rgba(0,0,0,0.35)", display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }}
        >
          <div
            onClick={(e) => e.stopPropagation()}
            style={{ background: "#fff", borderRadius: 20, padding: "30px 34px", width: "min(380px, 90vw)", textAlign: "center", boxShadow: "0 14px 50px rgba(0,0,0,0.28)", fontFamily: "'Nunito', sans-serif" }}
          >
