  ...
  return (
    <main style={{ flex: 1, padding: isMobile ? 14 : 24, overflowY: 'auto', background: bg }}>
                    ...
                    <div style={{ position: 'relative' }}>
                      <input
                        ...
                        style={{
                          ...inputStyle,
                          paddingRight: 42,
                          borderColor: confirmPassword && !conds.match ? C.red : inputBdr,
                        }}
                        onFocus={e => (e.currentTarget.style.borderColor = C.green)}
      ...
      {showPhotoOptions && (
        ...
        >
          <div
            style={{ background: card, borderRadius: 20, width: '100%', maxWidth: 320, overflow: 'hidden', boxShadow: '0 24px 64px rgba(0,0,0,0.25)' }}
          ...
          >
            <div style={{ background: `linear-gradient(135deg,${C.green},${C.teal})`, padding: '16px 20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <button
                onClick={() => setShowPhotoOptions(false)}
                style={{ background: 'rgba(255,255,255,0.2)', border: 'none', borderRadius: 8, padding: '4px 8px', cursor: 'pointer', color: '#fff', display: 'flex' }}
              >
                <X size={15} />
              </button>
            </div>
