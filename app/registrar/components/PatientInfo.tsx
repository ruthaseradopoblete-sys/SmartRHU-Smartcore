...
export default function PatientInfo({ patient, onClose }: { patient: any; onClose: () => void }) {
  ...
  const GH = ({ children }: { children: React.ReactNode }) => (
    <div style={{
      background: '#1a6b2e', color: '#fff', fontWeight: 700, fontSize: 6.3,
  ...
  const SYSTEMS = [
    ...
    { title: 'B. Chest / Breast / Lungs', ok: 'chest_other', items: [
      ...
      ['chest_lumps_over_breast',        'Lumps Over Breast'],
    ]},
  ...
  if (loading) return (
    <div style={{
      ...
      <div style={{
        background: '#fff', padding: 32, borderRadius: 8, color: '#1a6b2e',
  ...
  return (
    <div style={{
      ...
      <div style={{
        background: '#fff', width: '100%', maxWidth: 1260,
        ...
        <div className="pa" style={{
          ...
          <div style={{ display: 'flex', flex: 1, gap: 0, minHeight: 0 }}>
            ...
            <div style={{ flex: 1, paddingLeft: '2mm', display: 'flex', gap: 2, minHeight: 0 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                  ...
                  <div style={{ border: '2px solid #1a6b2e', padding: '2px 3px', marginBottom: 2, flex: 1, display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div style={{ fontSize: 5.3 }}>
                      {[
                        ['angina_has_chest_pain',         '1. Have you had any pain/discomfort pressure/heaviness in your chest? (Nakakaramdam ka ba ng pananakit o bigat sa iyong dibdib?)'],
                    ...
                    <div style={{ fontSize: 5.3, lineHeight: 1.25, marginBottom: .5 }}>
                      ...
                      (Nakaraman ka na ba ng ano man sa mga sumusunod: pagkautal, panghihina ng braso o binti, o pamamanhid ng kalahati ng katawan?)
                    </div>
              ...
              {/* ── far-right auth strip ── */}
              <div style={{ width: 14, flexShrink: 0, display: 'flex', flexDirection: 'column', border: '1px solid #333' }}>
