      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0 }}>
        ...
        <div ref={profileRef} style={{ position: 'relative' }}>
          ...
          >
            ...
            <div>
              <div style={{ color: '#fff', fontWeight: 600, fontSize: 13, lineHeight: 1.2, whiteSpace: 'nowrap' }}>
                {user?.name ?? 'Registrar'}
              </div>
          ...
          {showProfile && (
            <div style={{
              ...
              <div style={{ padding: '14px 16px', background: 'linear-gradient(135deg,#1b3a1b,#2d5a2d)', display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <div>
                  <div style={{ color: '#fff', fontWeight: 700, fontSize: 13 }}>{user?.name ?? 'Registrar'}</div>
                  <div style={{ color: 'rgba(255,255,255,0.6)', fontSize: 10, textTransform: 'uppercase', letterSpacing: 0.5 }}>{user?.role ?? 'registrar'}</div>
                </div>
              </div>
