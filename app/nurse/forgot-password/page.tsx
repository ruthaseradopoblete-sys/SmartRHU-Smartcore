...
export default function NurseForgotPasswordPage() {
        ...
        <div className={styles.authForm}>
          ...
          <div className={styles.authField}>
            ...
            <div className={styles.authInputWrap}>
              <input type={showNew ? 'text' : 'password'} className={styles.authInput} value={newPassword} onChange={e => setNewPassword(e.target.value)} />
          ...
          <div className={styles.authField}>
            ...
            <div className={styles.authInputWrap}>
              <input type={showConfirm ? 'text' : 'password'} className={styles.authInput} value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} />
